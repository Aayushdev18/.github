...
# Read the improved Lighthouse report
with open('lighthouse-report-improved.json', 'r') as f:
    data = json.load(f)

# Extract main category scores
categories = data['categories']
print("=== IMPROVED LIGHTHOUSE ANALYSIS RESULTS ===")
...
for audit in failing_audits[:5]:  # Show top 5 remaining issues
    print(f"⚠️ {audit['title']} (Score: {audit['score']})")
